module.exports = {
     ...
     createUserRef: "insert into users (user_id, user_email,full_name, username, user_phone, user_password, profile_image, reg_date, user_location, user_type,r_id,active, business_type) values (?, ?,?, ?, ?,?,?,?,?,?,?,false,?)",
