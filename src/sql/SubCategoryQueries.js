module.exports = {
     selectAll: "select s.sub_id, s.sub_name,s.fields, c.category_id, c.category_name, c.category_icon from sub_category s inner join category c on s.parent_id = c.category_id; ",
